          ...
          <div className="items-center flex flex-col sm:flex-row">
            <div class="max-w-2xl px-8 py-4 mx-auto bg-white rounded-lg shadow-md dark:bg-gray-900">
              ...
              <div class="mt-2">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-300">Join the StockPulse team as a Front-End Engineer to help us build beautiful and intuitive user-facing systems.</p>
              </div>
            ...
            <div class="mt-4 sm:mt-0 ml-0 sm:ml-2 max-w-2xl px-8 py-4 mx-auto bg-white rounded-lg shadow-md dark:bg-gray-900">
              ...
              <div class="mt-2">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-300">Join the StockPulse team as a Back-End Engineer to help us build reliable APIs and high-performance infrastructure.</p>
              </div>
              <div class="flex items-center justify-between mt-4">
                <p href="#" class="text-red-600 dark:text-red-400 cursor-not-allowed">Position Unavailable</p>
          ...
          <div className="mt-4 sm:mt-16 items-center flex flex-col sm:flex-row">
            <div class="max-w-2xl px-8 py-4 mx-auto bg-white rounded-lg shadow-md dark:bg-gray-900">
              ...
              <div class="mt-2">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-300">Join the StockPulse team as a DevOps Engineer to help us continuously deploy , test, scale and maintain our large scale operations.</p>
              </div>
              <div class="flex items-center justify-between mt-4">
                <p href="#" class="text-red-600 dark:text-red-400 cursor-not-allowed">Position Unavailable</p>
            ...
            <div class="mt-4 sm:mt-0 ml-0 sm:ml-2 max-w-2xl px-8 py-4 mx-auto bg-white rounded-lg shadow-md dark:bg-gray-900">
              ...
              <div class="mt-2">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-300">Join the StockPulse team as a Staff Accountant to help us keep track of our extensive financial and business operations.</p>
              </div>
              <div class="flex items-center justify-between mt-4">
                <p href="#" class="text-red-600 dark:text-red-400 cursor-not-allowed">Position Unavailable</p>
          ...
          <div className="mt-4 sm:mt-16 items-center flex flex-col sm:flex-row">
            <div class="max-w-2xl px-8 py-4 mx-auto bg-white rounded-lg shadow-md dark:bg-gray-900">
              ...
              <div class="mt-2">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-300">Join the StockPulse team as a Product Manager to oversee our vision, partaking in both engineering and business endeavours.</p>
              </div>
              <div class="flex items-center justify-between mt-4">
                <p href="#" class="text-red-600 dark:text-red-400 cursor-not-allowed">Position Unavailable</p>
            ...
            <div class="mt-4 sm:mt-0 ml-0 sm:ml-2 max-w-2xl px-8 py-4 mx-auto bg-white rounded-lg shadow-md dark:bg-gray-900">
              ...
              <div class="mt-2">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-300">Join the StockPulse team as a Data Scientist to help us analyze the crypto markets for our upcoming decentralized finance project.</p>
              </div>
              <div class="flex items-center justify-between mt-4">
                <p href="#" class="text-red-600 dark:text-red-400 cursor-not-allowed">Position Unavailable</p>
